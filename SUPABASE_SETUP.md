...
Перезапусти деплой сочищенным кэшем.
...
### 🚀 Quick validation
1. **Регистрация**
   - Зарегистрируй новый email — должен не бросать ошибки JSON.

2. **Вход**
   - Попробуй логиниться тем же email — должен авторизовать.

3. **Redirect**
   - Страница /dashboard должна редиректить незалогиненых на /login.
